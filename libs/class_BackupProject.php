...
class BackupProject
{
    static $allFiles = []; // Глобальний массив з всіма файлами
    static $fileNotZip = []; // Файли, які не попадають в архів
    static $dbNames = []; // Массив баз даних які потраплять у архів
    static $dbFiles = []; // Массив файлів з дампом баз даних
