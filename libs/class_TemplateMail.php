...
<a href="//childrensdream.com.ua'.$lang.'" target="_blank" title="www.childrensdream.com.ua" style="outline:none; display:inline-block;"><img src="'.$siteDirToFiles.'/skins/default/img/mails/cd-static.png" style="width:auto"></a>
...
<a target="_blank" style="width:100%; color:#482200;" href="'.hsc($siteDirToFiles.self::$goods[0]['link']).'">'.hsc(self::$goods[0]['name']).'</a>
</div>
<div class="goods" style="float:left; width:48%; margin:1%; text-align:center;">
<a target="_blank" style="display:inline-block; width:100%;" href=""><img src="'.hsc(self::$goods[1]['photo']).'" alt="'.hsc(self::$goods[1]['name']).'"></a>
<a target="_blank" style="width:100%; color:#482200;" href="'.hsc($siteDirToFiles.self::$goods[1]['link']).'">'.hsc(self::$goods[1]['name']).'</a>
</div>
<div style="clear:both;"></div>
</div>
...
<a href="//www.facebook.com/tmchildrensdream" target="_blank" style="display:inline-block; margin: 0 5px;"><img src="'.$siteDirToFiles.'/skins/default/img/mails/facebook.png"></a>
<a href="//vk.com/tmchildrensdream" target="_blank" style="display:inline-block; margin: 0 5px;"><img src="'.$siteDirToFiles.'/skins/default/img/mails/vk.png"></a>
<a href="//plus.google.com/u/0/101299485141835241705" target="_blank" style="display:inline-block; margin: 0 5px;"><img src="'.$siteDirToFiles.'/skins/default/img/mails/google_plus.png"></a>
<a href="//www.instagram.com/tm_childrens_dream" target="_blank" style="display:inline-block; margin: 0 5px;"><img src="'.$siteDirToFiles.'/skins/default/img/mails/instagram.png"></a>
<div style="clear:both;"></div>
</div>
