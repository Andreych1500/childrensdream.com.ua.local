  ...
  <div class="custom-content-form">
    <form action="" method="post" onsubmit="return okFrom();">
      <div class="line-custom">
        ...
        <input type="submit" value="Деактивувати" name="deactive"> <input type="submit" value="Видалити" name="delete">
      </div>
        ...
        <?php while($arResult = $products->fetch_assoc()){
          ...
          <tr>
            ...
            <td>
              ...
              <div class="menu-edit">
                <a href="/admin/products/edit?id=<?=(int)$arResult['id']?>"> <span class="icon-content"></span> Змінити
                </a>
            ...
            <td>
              <?php if(!empty($arResult['cAnonsPhoto'])){ ?>
                <div class="panel-photo">
                  <img src="<?=hsc($arResult['cAnonsPhoto'])?>" alt="<?=hsc($arResult['name_ua'])?>"></div>
              <?php } ?>
            </td>
