...
<head>
    ...
    <?=(Core::$META['dns-prefetch']? '<link rel="dns-prefetch" href="'.implode('"><link rel="dns-prefetch" href="', Core::$META['dns-prefetch']).'">' : '')?>
    ...
    <?php foreach (Core::$LINK_LANG as $k => $v) { ?>
        <link rel="alternate" href="<?=Core::$META['alternate_'.$v]?>" hreflang="<?=(($v == 'ua')? 'uk-UA' : $v.'-UA')?>">
    <?php } ?>
    ...
    <style><?=file_get_contents($_SERVER['DOCUMENT_ROOT'].'/skins/default/css/style.min.css')?></style>
    ...
    <script type="application/ld+json">
    {
      ...
      "logo" : {
          "url": "<?=$arMainParam['url_http_site']?>/skins/default/img/logo.png",
          "width": 186,
          "height": 96,
          "@type": "ImageObject"
      }
...
<body itemscope itemtype="http://schema.org/WebPage">
    ...
    <header itemscope itemtype="http://schema.org/WPHeader">
        <div class="header-block">
            ...
            <a class="mobile-basket" href="<?=$link_lang?>order/" rel="nofollow"><?=$messG['BASKET']?>
                <span><?=(int)$countG?></span>
            </a>

            <div class="mob-menu" onclick="showHide(this);">
                <span class="icon-mob-menu"></span><?=$messG['MOBILE_MENU']?>
            </div>
            ...
            <nav class="top-menu" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                <ul>
                    <li>
                        <a href="<?=$link_lang?>products/" title="<?=$messG['PRODUCTION_CH']?>" itemprop="url">
                            <span itemprop="name"><?=$messG['PRODUCTION']?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=$link_lang?>#payment" title="<?=$messG['SERVICES']?>" itemprop="url">
                            <span itemprop="name"><?=$messG['SERVICES']?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=$link_lang?>#call" title="<?=$messG['Зв\'язатись з нами']?>" itemprop="url">
                            <span itemprop="name"><?=$messG['Зв\'язатись з нами']?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=$link_lang?>comments/" title="<?=$messG['OTZUVU_SHOP']?>" itemprop="url">
                            <span itemprop="name"><?=$messG['OTZUVU']?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=$link_lang?>order/" rel="nofollow"><?=$messG['BASKET']?>
                            <span><?=(int)$countG?></span>
                        </a>
                    </li>
                </ul>
    ...
    <footer itemscope itemtype="http://schema.org/WPFooter">
        <div class="fix-position">
            <div class="development-site">&copy; <?=data(Core::$DATA)?> Інтернет магазин дитячих матраців Children's Dream. Права на всі матеріали сайту захищені та охороняються законом України про авторське право, їх повне або часткове копіювання - заборонено.</div>

            <img class="logo-img" src="/skins/default/img/cd-static.png" alt="Children's Dream" title="Children's Dream">

            <div class="soc-link">
                <div><?=$messG['SOC_LINK']?></div>
                <a href="//www.facebook.com/tmchildrensdream" target="_blank" class="icon-facebook"></a>
                <?php /*<a href="//vk.com/childrensdream" target="_blank" class="icon-vkontakte"></a>*/ ?>
            ...
            <ul class="simple-menu">
                <li>
                    <a href="<?=$link_lang?>privacy-policy/" title="<?=$messG['Політика конфіденційності']?>"><?=$messG['Політика конфіденційності']?></a>
                </li>
                <li>
                    <a href="<?=$link_lang?>oferta/" title="<?=$messG['Оферта покупця']?>"><?=$messG['Оферта покупця']?></a>
                </li>
                <li>
                    <a href="<?=$link_lang?>certification/" title="<?=$messG['Сертифікати']?>"><?=$messG['Сертифікати']?></a>
                </li>
                <li>
                    <a href="<?=$link_lang?>contacts/" title="<?=$messG['Контакти']?>"><?=$messG['Контакти']?></a>
                </li>
            </ul>
        </div>
    </footer>
