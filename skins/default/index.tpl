...
<head>
    ...
    <?php foreach (Core::$LINK_LANG as $k => $v) {
        echo '<link rel="alternate" href="'.Core::$META['alternate_'.$v].'" hreflang="'.(($v == 'ua')? 'uk-UA' : $v.'-UA').'">';
    } ?>
            ...
            <ul>
                ...
                <li>
                    <a href="<?=$link_lang?>#payment" title="<?=$messG['SERVICES']?>" itemprop="url">
                        <span itemprop="name"><?=$messG['SERVICES']?></span></a>
                </li>
                <li>
                    <a href="<?=$link_lang?>#call" title="<?=$messG['Зв\'язатись з нами']?>" itemprop="url">
                        <span itemprop="name"><?=$messG['Зв\'язатись з нами']?></span></a>
                </li>
                <li>
                    <a href="<?=$link_lang?>comments/" title="<?=$messG['OTZUVU_SHOP']?>" itemprop="url">
                        <span itemprop="name"><?=$messG['OTZUVU']?></span></a>
                </li>
                <li>
